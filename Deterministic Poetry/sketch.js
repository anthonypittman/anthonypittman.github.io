...
// Anthony and Alex
// DATE
// Favourite Poem: It all spring chickens darkness spiritual wine-shop coach-lamps
// atheistical seventy-five blunderbusses.  
let srcText;
let words;
function preload() {
...
function generateAcrostic() {
  ...
  //poem starts as an empty string. Use loop(s) to add to this!
